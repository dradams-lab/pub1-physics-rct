...
$\URA(\pi/4)$ (full duration, $\alpha = \pi/4$) is locally equivalent
to \textsc{iswap} and matches its fidelity exactly~---~confirming
the Weyl chamber analysis of Section~\ref{subsec:weyl}.
