...
We therefore postulate \emph{gate-time-proportional noise}: fixed gates
...
partial-exchange advantage we report below is therefore at $\theta < \pi/4$.
...
We emphasize that the near-equality between the depolarizing,
...
The \RCF~contributes the conceptual warrant for this design~---~that
