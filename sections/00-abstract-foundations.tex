...
% Foundations of Physics requires: 150-250 words, NO equations, NO citations.
% Trimmed/rewritten from sections/00-abstract.tex (the Quantum-journal
% abstract, ~319 words with 2 display equations and 6 citations) to meet
% this constraint. Canonical main.tex abstract is untouched.
